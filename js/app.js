(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-mini__slider")) var swiperone = new core(".slider-mini__slider", {
            modules: [ Thumb ],
            slidesPerView: 5,
            spaceBetween: 0,
            speed: 800,
        ...
        if (document.querySelector(".slider-column__slider")) new core(".slider-column__slider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
